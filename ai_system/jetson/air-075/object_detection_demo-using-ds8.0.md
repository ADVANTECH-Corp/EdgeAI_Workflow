...
### Prepare Files
 ...
 3. copy files below to directory "object-detect-deepstream"  
    /EdgeAI_Workflow/ai_system/jetson/air-075/script/labels.txt  
    /EdgeAI_Workflow/ai_system/jetson/air-075/script/deepstream_app_config_yoloV11_video.txt (input:video file)  
    /EdgeAI_Workflow/ai_system/jetson/air-075/script/deepstream_app_config_yoloV11_usb-camera.txt (input:usb-camera)  
    /EdgeAI_Workflow/ai_system/jetson/air-075/script/config_infer_primary_yolo11.txt  
    /EdgeAI_Workflow/ai_system/jetson/air-075/script/run_yolo11.sh  
