...
REM Common configuration for Gemma 3 4B OpenVINO conversion / OVMS workflow.
...
if not defined ENV_PATH set "ENV_PATH=%WORKSPACE%\envs\gemma3_4b_convert"
if not defined MODEL_ROOT set "MODEL_ROOT=%WORKSPACE%\models"
if not defined REST_PORT set "REST_PORT=23953"

if not defined RAW_MODEL_ID set "RAW_MODEL_ID=google/gemma-3-4b-it"
if not defined RAW_MODEL_NAME set "RAW_MODEL_NAME=gemma-3-4b-it-raw"
if not defined CONVERT_PRECISION set "CONVERT_PRECISION=int4"
if not defined CPU_IGPU_MODEL_NAME set "CPU_IGPU_MODEL_NAME=gemma-3-4b-it-converted-int4"
if not defined NPU_MODEL_NAME set "NPU_MODEL_NAME=gemma-3-4b-it-int4-cw-ov"
if not defined CPU_IGPU_PREPARED_REPO_ID set "CPU_IGPU_PREPARED_REPO_ID=OpenVINO/gemma-3-4b-it-int4-ov"
if not defined NPU_REPO_ID set "NPU_REPO_ID=OpenVINO/gemma-3-4b-it-int4-cw-ov"
...
set "RAW_MODEL_PATH=%MODEL_ROOT%\%RAW_MODEL_NAME%"
...
endlocal & (
  ...
  set "RAW_MODEL_ID=%RAW_MODEL_ID%"
  set "RAW_MODEL_NAME=%RAW_MODEL_NAME%"
  set "RAW_MODEL_PATH=%RAW_MODEL_PATH%"
  set "CONVERT_PRECISION=%CONVERT_PRECISION%"
  set "CPU_IGPU_MODEL_NAME=%CPU_IGPU_MODEL_NAME%"
  set "NPU_MODEL_NAME=%NPU_MODEL_NAME%"
  set "CPU_IGPU_PREPARED_REPO_ID=%CPU_IGPU_PREPARED_REPO_ID%"
