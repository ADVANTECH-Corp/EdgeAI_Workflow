# Developing an Object Detection Application on Qualcomm Dragonwing QCS6490 (Yocto) Using Qualcomm AI Hub
...
# Develop Flow
Follow these steps on the development platform (x86_64) to obtain a pre-trained AI model from the Qualcomm AI Hub, then optimize and convert it for the Qualcomm Dragonwing QCS6490 device. <br>

<a name="How-To-Use-AI-Hub"/>

## How to use Qualcomm AI Hub on an x86_64 host machine
...
Step 3. Install Qualcomm AI Hub Tools:<br>
    $ sudo apt install git <br>
    $ sudo apt install python3-pip -y <br>
    $ sudo pip install qai-hub <br>
  
Step 4. Install Qualcomm AI Hub Model:<br>
    $ qai-hub configure --api_token  **token-value(refer to Step 2)** <br>
    $ pip install "qai-hub-models[yolov8-det]" <br>
    $ qai-hub-models export yolov8_det --target-runtime tflite --precision w8a8 --chipset qualcomm-qcs6490 <br>
...
Step 7. To get label file:<br>
    ...
    => EdgeAI_Workflow/ai_sdk/qualcomm/qairt/2.20.0.240223/linux/labels/coco_labels.txt <br>
 
<a name="Deploy-AI-Hub"/>

# Deploy
Copy the optimized AI model (yolov8_det_quantized.tflite is created based on previous step) to target device and  launch an AI application with GStreamer pipeline.
...
## Download Script Files 
   Clone the repository to obtain the application scripts.<br> 
   ...
   => EdgeAI_Workflow/ai_sdk/qualcomm/qairt/2.20.0.240223/linux/script/yolov8_cam_ai_hub.sh <br>
   
   To run with video files (Any mp4 files named "ObjectDetection.mp4" in the working directory) <br>
   => EdgeAI_Workflow/ai_sdk/qualcomm/qairt/2.20.0.240223/linux/script/yolov8_videofile_ai_hub.sh <br>

## Result (usb camera)
 ![AI_Hub_sample_pic.png](../../../assets/2.20.0-npu.png)
